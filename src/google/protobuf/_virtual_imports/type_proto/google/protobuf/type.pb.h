...
#define PROTOBUF_INTERNAL_EXPORT_google_2fprotobuf_2ftype_2eproto
...
extern const uint32_t Field_Kind_internal_data_[];
...
extern const uint32_t Field_Cardinality_internal_data_[];
...
extern const uint32_t Syntax_internal_data_[];
...
class Enum final : public ::google::protobuf::Message
